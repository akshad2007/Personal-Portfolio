  ...
  const socialLinks = [
    {
      name: 'GitHub',
      icon: Github,
      url: 'https://github.com/akshad2007',
      color: 'hover:text-gray-300'
    },
    {
      name: 'LinkedIn',
      icon: Linkedin,
      url: 'https://www.linkedin.com/in/akshad-b-99a683325/',
      color: 'hover:text-blue-400'
    },
    {
      name: 'Instagram',
      icon: Instagram,
      url: 'https://instagram.com/_akshad_24_',
            ...
            {socialLinks.map((link) => {
              ...
              return (
                <a
                  ...
                  className={`text-gray-400 ${link.color} transition-colors duration-200 flex items-center space-x-2`}
