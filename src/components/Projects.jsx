...
const Projects = () => {
  ...
  const email = "akshadb27@gmail.com"; // Replace with your actual email
  ...
  const projects = [
    ...
    },
    {
      id: 2,
      title: "Hulu Clone",
      description: "A static clone of the Hulu homepage built using HTML and CSS. Designed by following a tutorial to strengthen layout and styling skills.",
      detailedDescription: "This project is a static recreation of the Hulu homepage, built using only HTML and CSS. It closely follows a hands-on tutorial from Apna College's YouTube channel.\n\nThe layout includes a header with navigation, search bar, promotional hero section, product grid layout, and footer. The focus was on mastering box model, Flexbox, and positioning techniques.\n\nNote: This version is not responsive and is best viewed on desktop. It was created as a foundational layout exercise without advanced media queries or mobile support.",
      status: "finished",
      githubLink: "https://github.com/akshad2007/Hulu-Clone-.git",
      liveLink: "https://amazon-clone-jandy.netlify.app/",
      tech: ["HTML", "CSS"]
    },
    
    {
      id: 4,
      title: "Culna Ai",
      description: "Culna is a web-based platform that allows users to explore, add, and manage their favorite dishes. Built using Express.js and MongoDB, it supports seamless GET and POST API requests for food items, making it easy to view and store recipes efficiently. The project focuses on creating a simple, interactive, and dynamic food experience for users",
      detailedDescription: "The platform’s clean and intuitive frontend interface (built to integrate smoothly with the backend) allows users to browse through a curated collection of dishes, explore detailed recipe instructions, and contribute their own culinary creations.",
      status: "ongoing",
      tech: ["React", "Node.js", "Express", "MongoDB", "Firebase Auth", "Tailwind CSS", "AI Integration"]
    },
    // {
    //   id: 5,
  ...
  const handleSocialClick = (platform) => {
    const urls = {
      linkedin: 'https://www.linkedin.com/in/akshad-b-99a683325/',
      instagram: 'https://instagram.com/_akshad_24_',
      github: 'https://github.com/akshad2007' // Replace with your actual GitHub username
    };
