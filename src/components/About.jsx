        ...
        <div className="grid lg:grid-cols-[1.4fr,1fr] gap-8 lg:gap-8 items-start">
          ...
          <div className={`order-2 lg:order-1 transition-all duration-1000 delay-300 ease-out ${
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="text-gray-300 text-base md:text-lg leading-relaxed font-light">
                My passion lies in cooking and culnary arts, where I find joy in experimenting with flavors and techniques.
                <span className="text-purple-400 font-medium">Interseted in filmaking and screenplay wriiting</span> come together to build meaningful web experiences.
              </p>
              
              <p className="text-gray-300 text-base md:text-lg leading-relaxed font-light">
                As a <span className="text-blue-400 font-medium">frontend developer</span> building with the MERN stack, I'm constantly 
              ...
              <p className="text-gray-300 text-base md:text-lg leading-relaxed font-light">
                I'm not just into coding but into more interactive experiences. Whether it's through <span className="text-blue-400 font-medium">web development, filmmaking, or culinary arts</span>,
              </p>
